...
const COMPONENTS: [string, string, string, string][] = [
  ["أطوال أضلاع T5 متعددة", "30 · 45 · 60 · 90 · 120 سم", "اختر طول ضلع T5 المناسب لمساحتك — قصيرة (30سم) للتجمعات الضيقة وطويلة (120سم) لتغطية الجدران. يحسب هكسلايت الكمية الدقيقة لكل طول تحتاجه.", "/bars.png"],
...
const FAQ: [string, string][] = [
  ["كيف أخطّط نظام إضاءة LED سداسي؟", "افتح هكسلايت في أي متصفح — بلا تثبيت أو حساب. انقر لوضع الألواح على الشبكة، اختر طول ضلع T5 (30/45/60/90/120 سم)، وتحدّد الأداة كل نوع موصل وتبني قائمة مواد كاملة بالكميات."],
  ...
  ["ما الأطوال المدعومة؟", "أضلاع T5 القياسية بأطوال فعلية 288.3 / 425 / 548.8 / 848.8 / 1148.8 مم (نظير 30 / 45 / 60 / 90 / 120 سم — تُقاس شاملة الأطراف فتقلّ ~5 سم عن الاسمي). استهلاكها التقريبي 5 / 7 / 10 / 14 / 18 واط وإخراجها 550 / 770 / 1100 / 1540 / 1980 لومن. القصيرة للتجمعات المدمجة والطويلة لتغطية أوسع، ويمكن مزجها في تصميم واحد."],
